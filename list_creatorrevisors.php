	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
			<h1>List of creator/revisors</h1>
			<p>The following people are activated as creator/revisors in the MC Upload App.</p>
			<?php

				require_once ("database_connect.php");

				$sql = "SELECT * FROM `view_creatorrevisors`";
