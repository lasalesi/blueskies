	  ...
	  <div id="content">
        <div class="content_item">
			...
			?>
		  	...
		  	<h1>Reset InfoCard for <?php echo $dhfname; ?></h1>
			<p>Are you sure you want to reset the InfoCard to status <i>requested</i>?</p>
			<form action="do_reset.php" method="post"> 
			<table>
				<tr class="entry">
					<td>ID</td>
				...
				<a href="list_closed.php">Return to list of closed items</a>
