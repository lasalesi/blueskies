  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li class="current"><a href="list_created.php">Created</a></li>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
			<h1>List of created InfoCards</h1>
			<p>These InfoCards have been ready and wait for completion by the <b>authors</b>.</p>
			<?php

				require_once ("database_connect.php");

				$sql = "SELECT * FROM `tbl_requests` WHERE `req_status` = 2";
				...
				while($row = $result->fetch_assoc()) {
					echo "<tr><td class='data'><a href='display.php?id=" . $row["req_id"]. "'>" . $row["req_id"] . "</a>" . 
						...
						"</td><td class='data'><a href='proc_completed.php?id=" . $row["req_id"]."'>Complete</a> <a href='display.php?id=" .$row["req_id"]."'>Display</a></td></tr>";
				}
					echo "</table>";
				} 
				else {
